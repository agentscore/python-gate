...
Includes the TEC-226 wallet-signer-match fields and the TEC-227 agent_memory
payload.
"""
...
def build_missing_identity_reason(base_url: str = "https://api.agentscore.sh") -> DenialReason:
    ...
    cold-start bootstrap path where TEC-227's memory hint is most useful.
    """
...
def denial_reason_to_body(reason: DenialReason) -> dict[str, Any]:
    ...
    # TEC-227 — cross-merchant pattern hint.
